...
(content1 = {
	'What are 5 Javascript data types':
		'Strings, Boolean, Number, Object, Undefined',

	'What is the use of isNaN function?':
		'It returns TRUE if the argument is not a number, otherwise it is false',
	...
	'What is a for-in loop?':
		"it's used to loop through the properties of an object",

	'What does "unshift" do?': 'It adds an item to the begining of an array',

	'How many ways can JavaScript be involved in HTML':
		'3, inline, internal, external',

	'What does "const" mean?':
		"It's a variable assignment that cant be reassigned",
